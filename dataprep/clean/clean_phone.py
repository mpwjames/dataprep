...
def clean_phone(
    ...
    if output_format not in {"full", "national", "dashes"}:
        raise ValueError(
            f'output_format {output_format} is invalid, it needs to be "full", \
                "national" or "dashes"'
        )
...
def format_phone(
    ...
    if split:
        ...
        if output_format == "full":
            ...
            ext_num = "ext." + ext_num if ext_num is not None else ""
